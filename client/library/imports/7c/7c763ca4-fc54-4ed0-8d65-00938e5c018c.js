"use strict";
cc._RF.push(module, '7c763yk/FRO0I1lAJOOXAGM', 'item');
// script/home/bag/item.js
...
cc.Class({
    ...
    minusBagLab: function minusBagLab(data) {
        if (data['type'] == this.node.name) this.itemLab.string = parseInt(this.itemLab.string) - 1;
    },
    updateItems: function updateItems(data) {
        if (_global2.default.configConf['item'][data['item_id']]['showType'] == 'item') {
